...
int main()
{
    ...
    cout<<"Marvellour linked list application \n";
    ...
    while(1)
    {
        ...
        cout<<"8 : count numbar of nodes from Linked List\n";
        cout<<"9 : Terminated the application\n";
        ...
        switch(iChoice)
        {
            ...
            case 8:
                cout<<"Numbar of elements are : "<<obj.Count()<<"\n";
                break;
